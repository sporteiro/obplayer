...
class ObTCPStreamer (ObGstStreamer):
    def __init__(self):
        ObGstStreamer.__init__(self, 'tcp')

        #self.mode = output_settings[obplayer.Config.setting('streamer_tcp_mode')]
        ...
        #self.encoder.set_property('bitrate', 128000)
        #self.encoder.set_property('compliance', -2)
        ...
        caps.set_property('caps', Gst.Caps.from_string("video/x-raw,format=I420,width=1280,height=720,framerate=25/1"))
        ...
        self.videopipe[-1].set_property('speed-preset', obplayer.Config.setting('streamer_tcp_mode'))
        ...
        self.commonpipe.append(Gst.ElementFactory.make("tcpserversink"))
	
        self.commonpipe[-1].set_property('host', obplayer.Config.setting('streamer_tcp_url'))
        self.commonpipe[-1].set_property('port', obplayer.Config.setting('streamer_tcp_port'))
