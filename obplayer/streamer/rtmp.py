...
class ObRTMPStreamer (ObGstStreamer):
    def __init__(self):
        ...
        self.videopipe[-1].set_property('speed-preset', obplayer.Config.setting('streamer_rtmp_mode'))
        ...
        self.commonpipe[-1].set_property('location', obplayer.Config.setting('streamer_rtmp_url'))
        #self.commonpipe[-1].set_property('location', "rtmp://a.rtmp.youtube.com/live2/x/" + obplayer.Config.setting('streamer_rtmp_key'))
